****<!--
  ...
  Nota: el correo proporcionado por usted fue: "dd.contable46.com". Si su correo contiene un '@', reemplácelo en el campo correspondiente.
-->
<!doctype html>
<html lang="es">
<head>
...
<body>
  <div class="container">
      ...
      <div class="card">
        ...
        <div class="grid-3" style="margin-top:12px">
          <div>
            ...
            <p class="muted">Cálculo, revisión de soportes, optimización de deducciones y entrega del archivo para DIAN. Incluye explicación detallada y recomendaciones para el siguiente año.</p>
          </div>
          <div>
    ...
    <section id="faq" style="margin-top:18px">
      <div class="card">
        ...
        <div style="margin-top:8px">
          ...
          <div class="muted">Certificados de ingresos y retenciones, extractos bancarios, facturas de gastos deducibles, resolución de arrendamiento (si aplica) y otros soportes.</div>
        </div>
        <div style="margin-top:8px">
          <strong>¿Cobran por revisión previa?</strong>
          <div class="muted">Ofrecemos revisión inicial gratuita de hasta X páginas; para revisiones extensas aplican tarifas claras que acordamos antes.</div>
        </div>
      </div>
    </section>
    ...
    <section id="form" style="margin-top:18px">
      <div class="card">
        <h3>Escríbeme</h3>
        <p class="muted">Usa el formulario o comunícate por teléfono. (Este formulario no envía correos automáticamente; sirve como borrador para copiar y pegar en tu correo.)</p>
